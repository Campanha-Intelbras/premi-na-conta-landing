      ...
      <div className="container relative z-10 px-4 py-20">
        <div className="max-w-4xl mx-auto text-center text-primary-foreground">
          ...
          <Button
            ...
            size="lg"
            className="bg-gradient-to-r from-[#00ff88] to-[#00d084] hover:from-[#00d084] hover:to-[#00a86b] text-secondary-foreground text-lg px-8 py-6 rounded-xl shadow-glow animate-pulse-glow will-change-transform border-2 border-[#00ff88]"
          >
            Participar Agora
